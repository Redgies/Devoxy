...
class LivreurDeJourneaux extends Job {
    ...
    startWork(player) {
        if (player.loyality < 10) return player.notify(`~r~${i18n.get('basic', 'needMoreLoyality1', player.lang)} 10 ${i18n.get('basic', 'needMoreLoyality2', player.lang)}!`);
    ...
    enteredDropShape(player) {
        ...
        if (player.loyality < 20) player.addLoyality(player.job.collected / 10);
