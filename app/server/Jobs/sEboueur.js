...
class Eboueur extends Job {
    ...
    createMenuToDrop() {
        ...
        this.dropLabel = mp.labels.new("Décharge", new mp.Vector3(this.posToDrop.x, this.posToDrop.y, this.posToDrop.z),
        {
            los: false,
            font: 2,
            drawDistance: 5,
    ...
    enteredDropShape(player) {
        ...
        const earnedMoney = player.vip ? (player.job.collected * 290 * 1.10) : player.job.collected * 290;
